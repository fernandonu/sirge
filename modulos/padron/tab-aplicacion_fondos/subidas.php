		...
		$("#dialog-confirm").dialog({
			...
			buttons: {
				"Aceptar" : function () {
					...
					$.ajax({
						type : 'post' ,
						data : 'acc=del-archivo&padron=fondos&file=' + file ,
						...
						success : function(data) {
							...
							$("#dialog-respuesta").dialog({
								...
								buttons: {
									Ok: function() {
										$(".listado-archivos-subidos").load("modulos/padron/tab-aplicacion_fondos/subidas.php .listado-archivos-subidos table");
										$(this).dialog("close");
									}
								}
							});
			...
			buttons: {
				"Aceptar" : function () {
					...
					$.ajax({
						type : 'post' ,
						data : 'file=' + file ,
						url  : 'funciones/valida_aplicacion_fondos_nuevo_formato.php' ,
						success : function(data) {
...
<div class="listado-archivos-subidos">
	<table>
		<thead>
			<tr >
				<th style="background-color: rgb(204,51,63)">Nombre</th>
				<th style="background-color: rgb(204,51,63)">Fecha de carga</th>
				<th style="background-color: rgb(204,51,63)">Tama&ntilde;o</th>
				<th style="background-color: rgb(204,51,63)">Procesar</th>
				<th style="background-color: rgb(204,51,63)">Eliminar</th>
			</tr>
		</thead>
		<tbody>
			<?php
