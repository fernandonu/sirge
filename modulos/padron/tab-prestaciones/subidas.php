		...
		$("#dialog-confirm").dialog({
			...
			buttons: {
				"Aceptar" : function () {
					...
					$.ajax({
						type : 'post' ,
						data : 'acc=del-archivo&padron=prestaciones&file=' + file ,
						...
						success : function(data) {
							...
							$("#dialog-respuesta").dialog({
								...
								buttons: {
									Ok: function() {
										$(".listado-archivos-subidos").load("modulos/padron/tab-prestaciones/subidas.php .listado-archivos-subidos table");
										$(this).dialog("close");
									}
								}
							});
			...
			buttons: {
				"Aceptar" : function () {
					...
					$.ajax({
						type : 'post' ,
						data : 'file=' + file ,
						url  : 'funciones/valida_prestaciones_nuevo_formato.php' ,
						success : function(data) {
